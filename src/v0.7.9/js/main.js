  ...
  (function () {
    ...
    if (window.URL) {
      ...
      $("#download").click(function () {
          ...
          saveBase64AsFile( $image.cropper("getDataURL"), "imgName"+(imgCounter++) + ".jpg");
          // saveBaseBlobAsFile( $image.cropper("getDataURL"), "imgName"+(imgCounter++) + ".jpg");

      });

      function saveBase64AsFile(base64, drawingFileName){

          var link = document.createElement("a");

          link.setAttribute("href", base64);
          link.setAttribute("download", drawingFileName);
          link.click();
      }



      function saveBaseBlobAsFile(base64, drawingFileName) {
          var blob = new Blob([base64], {type: "text/plain;charset=utf-8"});
          saveAs(blob, drawingFileName);
      };
